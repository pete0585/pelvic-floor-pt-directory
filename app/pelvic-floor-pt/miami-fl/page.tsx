...
export const metadata: Metadata = {
    ...
    description: 'Find pelvic floor physical therapists in Miami, FL. Florida direct access laws mean no referral needed. Browse specialists across Miami-Dade and Broward counties.',
      ...
      <div className="py-10 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-wrap gap-2 mb-10">
            {['Miami', 'Coral Gables', 'Brickell', 'Coconut Grove', 'Doral', 'Hialeah', 'Fort Lauderdale', 'Hollywood FL', 'Aventura'].map((area) => (<span key={area} className="px-3 py-1.5 bg-stone-100 rounded-full text-xs font-medium text-stone-600">
                {area}
              </span>))}
          </div>
          ...
          {listings.length > 0 ? (<>
              <div className="mb-6 flex items-center justify-between">
                ...
                <Link href={`/listings?location=${encodeURIComponent('Miami, FL')}`} className="flex items-center gap-1.5 text-sm text-teal hover:text-teal-400">
              ...
              <div className="mt-8 text-center">
                <Link href={`/listings?location=${encodeURIComponent('Miami, FL')}`} className="btn-primary">
          ...
          <section className="mt-16 rounded-2xl bg-teal p-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link href="/listings?state=Florida" className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white/50 px-8 py-3 text-sm font-semibold text-white hover:border-white transition-colors">
